...
const PrimaryCard = props => {
    console.log('in PrimaryCard', props.primaryData.avatar_url);
    return(
        <div>
<Card className='primary-card'>
<CardImg className='primary-img' src={props.primaryData.avatar_url}></CardImg> 
<CardBody>
<CardTitle>{props.primaryData.name}</CardTitle>
<a href={`https://github.com/${props.primaryData.login}`}><CardSubtitle>GitHub Handle: {props.primaryData.login}</CardSubtitle></a>
...
<CardText className={`${props.primaryData.bio ? '' : 'hide-bio'}`} >Bio: {props.primaryData.bio}</CardText>
</CardBody>
</Card>
        </div>
    )
